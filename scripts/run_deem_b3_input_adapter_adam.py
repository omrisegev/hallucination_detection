#!/usr/bin/env python3
"""Run the adapter-only Adam actuation screen without labels."""
...
from spectral_utils.deem_b3_input_adapter_adam import ARMS,fit_adapter_adam
...
SCHEMA="deem_b3_input_adapter_adam_seed0_2026_08_25"
def fit_cell(payload):
 ...
 for arm in ARMS:
  result,bases,diagnostics=fit_adapter_adam(prepared,arm,seed=0)
