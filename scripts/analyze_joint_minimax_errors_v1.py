...
ARMS=('base__minimax','near_copies__minimax','base__previous','base__feasible_reference','innovation5','historical_bocpd')
...
def main():
    ...
    for name,s in scores.items():
        ...
        summary[name]=row
    changes={}
    for left,right in [('base__minimax','base__previous'),('base__minimax','base__feasible_reference'),
                       ('near_copies__minimax','base__minimax'),('base__minimax','innovation5')]:
