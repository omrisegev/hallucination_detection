...
# This module works in sets; scripts/inscope_cells.py is the ordered source of truth.
from inscope_cells import QA_CELLS as _QA, MATH_CELLS as _MATH  # noqa: E402

QA_CELLS = set(_QA)
MATH_CELLS = set(_MATH)
