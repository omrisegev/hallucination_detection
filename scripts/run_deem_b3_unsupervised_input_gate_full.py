#!/usr/bin/env python3
"""Five-seed target-free finalist for the cross-fitted static R2 input gate."""
...
from spectral_utils.deem_b3_unsupervised_input_gate import MAX_GATE,fit_unsupervised_gate
...
SCHEMA="deem_b3_unsupervised_input_gate_full_2026_08_25"; ARM="M1_ROOK_STATIC_R2"; SEEDS=(0,1,2,3,4)
def fit_cell(payload):
 ...
 for seed in SEEDS:
  result,gate_map=fit_unsupervised_gate(prepared,bundle.group_ids,bundle.raw_trace_length,ARM,seed=seed)
  ...
  meta={"schema":SCHEMA+"_fit","cell_id":cell,"dataset_family":bundle.dataset_family,"arm":ARM,"seed":seed,"npz_sha256":digest,"health":result.health,"gate_diagnostics":gate_map.diagnostics,"source_bundle_sha256":bundle.bundle_sha256,"run_definition_sha256":definition_hash,"labels_accessed_during_fit":False,"target_module_imported_during_fit":False}; meta["content_sha256"]=canonical_sha256(meta); meta_path=path.with_suffix(".json"); atomic_write_json(meta_path,meta)
