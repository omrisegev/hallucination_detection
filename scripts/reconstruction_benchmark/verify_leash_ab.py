#!/usr/bin/env python3
"""Verify transitive byte identity of target-blind LEASH fit A/B."""
...
from spectral_utils.reconstruction_benchmark.leash_ab import verify_leash_fit_ab  # noqa: E402
...
def main() -> None:
    ...
    certificate = verify_leash_fit_ab(
        source_root=args.source_root,
        registry_path=args.registry,
        preparation_a=base / "A/preparation", preparation_b=base / "B/preparation",
        preparation_ab_certificate=base / "PREPARATION_AB_VERIFICATION.json",
        fit_a=base / "A/fit", fit_b=base / "B/fit",
        certificate_path=args.output or base / "FIT_AB_VERIFICATION.json",
    )
