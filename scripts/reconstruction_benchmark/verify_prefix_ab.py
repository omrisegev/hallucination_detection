#!/usr/bin/env python3
"""Verify exact A/B causal-prefix score recomputation."""
...
from spectral_utils.reconstruction_benchmark.prefix_ab import verify_prefix_score_ab  # noqa: E402
...
def main() -> None:
    ...
    if status.strip() and not args.allow_debug:
        raise RuntimeError("scientific prefix score verification requires a clean worktree")
    certificate = verify_prefix_score_ab(
        repo=REPO,
