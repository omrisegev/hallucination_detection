#!/usr/bin/env python3
"""Rederive raw sources and certify independent RAG preparation builds."""
...
from spectral_utils.reconstruction_benchmark.rag_evidence_ab import verify_rag_evidence_preparation_ab
...
def main() -> None:
    ...
    certificate = verify_rag_evidence_preparation_ab(
