#!/usr/bin/env python3
"""Build one immutable certified multi-lane unified reporting release."""
...
def main() -> None:
    ...
    parser.add_argument("--build-id", required=True, help="Independent build identity, e.g. A or B.")
