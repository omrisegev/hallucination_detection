#!/usr/bin/env python3
"""Verify transitive, grouped-bootstrap LEASH evaluation A/B."""
...
from spectral_utils.reconstruction_benchmark.leash_evaluation import verify_leash_evaluation_ab  # noqa: E402
...
def main() -> None:
    ...
    certificate = verify_leash_evaluation_ab(
        source_root=args.source_root,
        preparation_a=base / "A/preparation", fit_a=base / "A/fit",
        private_a=private / "A/outcomes", evaluation_a=base / "A/evaluation",
        preparation_b=base / "B/preparation", fit_b=base / "B/fit",
        private_b=private / "B/outcomes", evaluation_b=base / "B/evaluation",
        preparation_ab_certificate=base / "PREPARATION_AB_VERIFICATION.json",
        fit_ab_certificate=base / "FIT_AB_VERIFICATION.json",
        registry_path=args.registry,
        certificate_path=args.output or base / "EVALUATION_AB_VERIFICATION.json",
    )
