...
- Yaniv Tenzer, Omer Dror, Boaz Nadler, Erhan Bilal and Yuval Kluger. [**Crowdsourcing Regression: A Spectral Approach.**](https://proceedings.mlr.press/v151/tenzer22a.html) AISTATS 2022. Supplies the IU-PCR/SU-PCR framing and the low-rank-plus-sparse covariance model.
...
- Ofir Lindenbaum, Uri Shaham, Jonathan Svirsky, Erez Peterfreund and Yuval Kluger. [**Differentiable Unsupervised Feature Selection based on a Gated Laplacian.**](https://proceedings.neurips.cc/paper/2021/hash/0bc10d8a74dbafbf242e30433e83aa56-Abstract.html) NeurIPS 2021. Inspired both direct gate-ranking experiments and the continuous DUFS-LIU sample graph; DUFS-LIU is our adaptation.
...
- Chen et al. **Mind the Gap: Catching Hallucinations via Evidence Drop on the Reasoning Manifold.** ICML 2026. Main label-free localization comparator.
- Mingyang Song et al. **PRMBench: A Fine-grained and Challenging Benchmark for Process-Level Reward Models.** ACL 2025. Supplies the separate every-step error labels; it is not another first-error ProcessBench result.
- Zhenru Zhang et al. **The Lessons of Developing Process Reward Models in Mathematical Reasoning.** Source of the supervised Qwen2.5-Math-PRM-7B ceiling used on PRMBench.
