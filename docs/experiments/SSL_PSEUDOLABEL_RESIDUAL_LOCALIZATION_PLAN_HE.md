...
**גרסה:** 1.1 — 2026-09-23; עודכנה בעקבות התוצאות הסופיות של Claude, Steps 430–432 / A1. **סטטוס:** תוכנית למימוש; במסגרת כתיבתה בוצע ניתוח read-only של ציונים קיימים, ללא אימון או inference חדשים.
