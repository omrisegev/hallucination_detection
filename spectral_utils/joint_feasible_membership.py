"""Step410 staged membership with group rediscovery during refinement."""
import numpy as np
...
from .joint_feasible_refinement import refine_feasible
from .lsml_gate_locator_research import _orient


def fit_feasible_joint(values,offsets,source_ids,inner_folds,*,anchor_index,seed=399170,notify=None):
    ...
    try:
        ...
        fit=refine_feasible(z[:,initial],part,np.repeat(inner_folds,np.diff(offsets)),
