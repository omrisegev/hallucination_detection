...
from .joint_mass_structure import learn_mass_structure
from .joint_mass_refinement import refine_mass
from .lsml_gate_locator_research import _orient


def fit_mass_joint(values,offsets,source_ids,inner_folds,*,anchor_index,seed=399170,notify=None):
    ...
    try:
        ...
        membership=learn_mass_structure(z,np.repeat(inner_folds,np.diff(offsets)),gram,int(sizes.sum()),
        ...
        fit=refine_mass(z[:,initial],part,np.repeat(inner_folds,np.diff(offsets)),
