"""Step409 staged membership with group rediscovery during refinement."""
import numpy as np
...
from .joint_regroup_refinement import refine_with_regrouping
from .lsml_gate_locator_research import _orient


def fit_regroup_joint(values,offsets,source_ids,inner_folds,*,anchor_index,seed=399170,notify=None):
    ...
    try:
        ...
        fit=refine_with_regrouping(z[:,initial],part,np.repeat(inner_folds,np.diff(offsets)),
