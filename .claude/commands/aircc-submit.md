---
description: Submit an inference job to the AIRCC cluster — syncs the working tree, runs sbatch with the right partition/QoS, and reports the job id. Accepts DATASET (gsm8k|math500|amc23|aime24), TEMPS, K, N, MAX_NEW, OUT; asks for missing parameters.
---
...
Required: `DATASET` ∈ {gsm8k, math500, amc23, aime24}. Ask if not given.
